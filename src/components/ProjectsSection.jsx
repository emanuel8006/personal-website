...
const projects = [
   {
    id: 1,
    title: "Project Prometheus Landing Page",
    description: "A beautiful landing page app using React and Tailwind.",
    image: "/projects/ProjectPrometheus.png",
    tags: ["React+Vite", "JSX", "TailwindCSS", "Supabase", "Python", "GeminiAPI", "AWS Amplify"],
    demoUrl: "#", // replace with deployed website url
   ...
   return (
      <section id="projects" className="py-24 px-4 relative">
         <div className="container mx-auto max-w-5xl">
            <h2 className="text-3xl md:text-4xl font-colf mb-4 text-center"> 
               Featured
                     ...
                     <div className="p-6">
                        <div className="flex flex-wrap gap-2 mb-4">
                           {project.tags.map((tag) => (
                              <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/25 text-secondary-foreground">
                                 {tag}
                              </span>
                           ))}
                        </div>
